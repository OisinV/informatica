...
colour = ['orange', 'yellow', 'white', 'green', 'red', 'brown', 'MidnightBlue']
...
def cube(size:int, colouring:int, gfor:bool = False):
...
for i in range(500):
    teleport(random.randint(0, 500), random.randint(-500, 500))
